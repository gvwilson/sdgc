...
awaiting the right institutional fix [%b Berlin1991 %].
...
That process is [%g workplace-politics "workplace politics" %].

Bueno de Mesquita and Smith developed a framework called [%g selectorate-theory "selectorate theory" %]
...
They are what the theory calls the [%g selectorate "selectorate" %]:
...
are stronger predictors of career advancement than technical competence [%b Pfeffer1992 %].
...
and [%g predictive-policing "predictive policing" %] tools share two structural features
...
and their conclusion was not what most people expect [%b Mullainathan2013 %].
