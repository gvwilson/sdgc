...
Liberty and equality, security and freedom, efficiency and fairness:
...
::: {.callout-note title="Basecamp and Footguns"}
...
and these categories shape who finds it easy to enter a winning coalition
...
it is the settled position of geneticists,
...
but because they were systematically excluded from
the wealth-building mechanisms that credit history reflects.
...
::: {.callout-note title="The Social Credit System"}
...
They did not know (or had not thought through the fact)
that some libraries require a membership card to use their computers,
