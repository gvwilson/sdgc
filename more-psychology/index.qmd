...
The [previous section on psychology](../a-little-psychology/index.qmd) explained how
...
The economy doesn't exist to satisfy people's needs:
...
The procedures most in demand,
such as eyelid surgery, jaw reduction, and particular kinds of nose jobs,
track the standards of appearance disseminated through Korean entertainment products,
...
This is distinct from the nudging described [previously](../a-little-psychology/index.qmd).
...
many of which contain harmful ingredients
doesn't reflect a natural preference.
...
::: {.callout-note title="This Time It's Different"}

Japan's stock and real estate bubble peaked in December 1989,
when land in Tokyo was theoretically worth more than all US real estate.
It was followed by thirty years of stagnation
...
Crucially,
the losses did not fall on the banks that had made the bad loans:
the US government covered those.
...
the ability to display the {{<g cultural-capital "cultural capital">}}
such as tastes, manners, and cultural references
that signal membership in the right networks.
...
::: {.callout-note title="Getting the Right Answer"}

India's IIT and IIM entrance examinations were designed as objective filters,
but a coaching industry whose best programs charge fees
equivalent to several years of average household income
ensures that upper-caste and wealthy families dominate admission lists
despite formally caste-neutral scoring.
...
The other person was a confederate: the shocks were fake and the screams were recorded.
...
::: {.callout-note title="Normalization of Deviance"}
