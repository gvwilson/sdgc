-- links.lua
-- Resolve "@key" link targets using _extras/links.md, failing if a key is
...
do
  ...
  local f = assert(io.open(root .. "/_extras/links.md", "r"), "links.lua: cannot open _extras/links.md")
