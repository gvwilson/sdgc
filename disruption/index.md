...
[%b Wainwright2017 %] is one of my favorite books.
...
In the 2010s, Mexican cartels moved into extorting avocado and lime farmers in Michoacán,
using territorial violence and supply chain control to extract rents from legal agricultural markets,
showing that the cartel business model applies to any sector
where legal institutions cannot enforce contracts.
...
it's about how legendary frauds reveal the workings of the world,
...
[%b Palazzo2025 Perrow1999 Schneier2023 %].
...
Email, RSS, the open hyperlink, and the early web were [%g commons "commons" %]:
...
Brazil's *grilagem*—the fraud of converting indigenous and public Amazon land into private titled property
using falsified documents—has been digitized in recent decades,
with forged records fed into government registries to launder claims at a scale
that replicates the logic of the Enclosure Acts across a continent.
