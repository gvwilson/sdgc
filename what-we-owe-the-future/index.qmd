...
If future people will have the same moral status as present people,
which seems hard to deny,
then the fact that they don't exist yet
...
The problem is that the premise—that we can make meaningful probability estimates
about civilization-scale outcomescenturies or millennia into the future—is not grounded in anything.
...
we are accountable for what we hand on,
even if the beneficiaries aren't in the room.
