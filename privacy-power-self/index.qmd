...
for terms associated with terrorism, drugs, or other sensitive topics.
This didn't happen because fewer people were curious,
...
trying to solve what James C. Scott calls the {{<g legibility "legibility">}} problem [@Scott1998].
...
to prevent accountability for torture.
For example,
the Abu Ghraib photographs were eventually published,
...
while using forced transparency such as public trials, and published confessions
as weapons against opponents.
...
(i.e.,
protecting the private lives of individuals
