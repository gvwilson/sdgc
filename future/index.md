...
Whether that intuition can be defended is harder than it looks.
...
They can't sign contracts, cast votes, or sue us.
They don't even exist yet.
And yet we act—sometimes—as if we owe them something.
The question is whether that behavior reflects a coherent moral position
or just a vague sentiment we invoke when it's convenient and ignore when it's expensive.
...
the people born in 2050 would be different people from the ones who will actually be born—because
different parents would have met,
...
present voters and legislators have no electoral incentive
...
Pension systems are underfunded while present spending continues.
...
where our actions had local, reversible consequences [%b Jonas1984 %].
That may be true,
but it doesn't explain why the frameworks have remained so convenient.

The uncomfortable hypothesis is that "what we owe the future" functions primarily as rhetoric—a
way of gesturing at seriousness without having to do anything.
Thirty years of climate pledges backed by thirty years of continued extraction
is fairly strong evidence.
The revealed preference is not the stated preference.
...
In *The Crooked Timber of Humanity*—the title taken from Kant's observation that
"out of the crooked timber of humanity, no straight thing was ever made"—he argued
that the goods people pursue are genuinely plural and genuinely irreconcilable
[%b Berlin1991 %].
...
the belief that there is one supreme value—
freedom, or utility, or the glory of the nation, or the arc of history, or expected future welfare—
...
you have given yourself an algorithm that can justify any present harm.
If the supreme value is large enough—and nothing is larger than the welfare of all future humanity
across trillions of lives over millions of years—
the calculation can authorize anything done to anyone living now.
...
It is a system specifically designed for a world in which there is no right answer—
in which the goods people legitimately pursue are irreconcilably in tension
...
as that happens,
wealth becomes concentrated in fewer and fewer hands [%b Piketty2017 %].
...
no loyalty to democratic constraints [%b McGrann2026 %].
...
The most defensible version of the obligation is also the least demanding:
don't foreclose options.
Leave the world in a state where future people have recoverable situations
rather than permanent damage.
A forest can be replanted.
A fishery, given time, can recover.
An extinct species cannot come back.
A melted ice sheet, on any human timescale, is gone.

We are not the owners of the conditions that make civilization possible.
We are trustees,
