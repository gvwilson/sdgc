...
made the scale of the NSA's surveillance clear [%b Snowden2020 %],
...
what sustained surveillance does over time [%b Funder2011 %].
...
and in the contemporary practice of [%g doxxing "doxxing" %].
...
is not available in physical form [%b Gray2009 %].
...
In the Soviet Union,
hand-typed, passed-by-hand underground literature called [%g samizdat "*samizdat*" %]
...
to stop-and-frisk policing and facial recognition [%b Browne2015 %].
...
and further amounts in lost personal income tax [%b Zucman2015 %].
...
requires organized political effort to sustain [%b Scott1998 %].
