...
::: {.callout-note title="Canadians in Delaware"}
...
::: {.callout-note title="Why Your Backpack Got Worse"}
...
::: {.callout-note title="The Browser Wars"}
...
::: {.callout-note title="Public Expense, Private Profit"}
...
The NIH's claim to a share of the intellectual property,
which would have given the government some leverage over pricing,
was disputed by Moderna and ultimately not enforced.
...
disappears entirely [@Chang2012;@Acemoglu2023;@Webber2011].
