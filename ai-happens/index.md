# When the Algorithm Comes for You

A lot of people are afraid that AI is going to take their jobs.
That fear is legitimate;
it's the same one that swept through agriculture when mechanization arrived in the nineteenth century,
through craft manufacturing when factory automation took over in the twentieth,
and through office work when computers eliminated most routine clerical jobs in the decades after that,
and in each case the fear was partly right.
New work appeared, but not the same work,
...
Much of that text and code was produced by people who received no payment and gave no consent.
These systems generate statistically plausible outputs;
They do not understand what they are saying,
cannot verify whether their outputs are accurate,
and have no reliable mechanism for distinguishing confident-sounding nonsense from correct reasoning
[%b TorresGebru2024 %].
...
As described in [the lesson on who owns what](@/ownership/),
...
By 2023 that figure was 12.8 million.
The jobs that replaced the ones that were shipped overseas or automated
were often in different sectors or different regions
(and usually lower paid).
Towns built around steel mills or textile factories did not quietly reinvent themselves as technology hubs.
They lost population, services, and tax base simultaneously,
and many have not recovered.]

The economist Daron Acemoglu estimates that roughly half of the increase in US income inequality since 1980
can be attributed to automation that systematically replaced mid-wage workers with machinery and software.
The gains from automation go to whoever owns the tools,
while the cost of retraining, years of lower wages, and the disruption of moving somewhere else
fall on the workers who are displaced.
How those costs and gains are distributed is a policy choice,
not an inevitable consequence of technical progress.
Every previous major automation wave distributed them badly,
...
The [lesson on disruption](@/disruption/) described this pattern:
attract users with artificially low prices, build dependencies,
then raise prices once alternatives have been squeezed out.
Enshittification applies to AI exactly as it applied to search engines and social media platforms.
The useful, affordable version of these tools will not survive for long,
and the developers, writers, and companies that build workflows around them during the subsidized period
...
They placed former employees and allies in regulatory positions
...
This is regulatory capture in its early stages.
...
In 2023, the Writers Guild of America struck for five months over issues that included AI.
...
that included restrictions on the digital replication of performers' likenesses without ongoing consent
[%b Kelly2022 %].
...
The structure of the problem is the same as every other power contest described in this course.
Organized, sustained collective action is what has imposed real constraints on industries
with strong incentives to resist.
Individual choices about which tools to use
matter much less than collective choices about what rules govern those tools.
The question is not whether to act but where to direct the effort.
