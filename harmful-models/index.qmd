...
The {{<g propaganda-model "propaganda model">}} [@Herman1988] describes how
...
::: {.callout-note title="Social Media as Scientology"}
...
{{<g excommunication "Excommunication">}}
(removal from the Church's services)
meant you could not conduct legal business.
...
with no {{<g due-process "due process">}} and no external authority to appeal to [@Southern1990].
