...
The [psychology section](@root/psychology/) explained how
...
This is distinct from the nudging described in the [psychology section](@/psychology/).
...
who created them,
or why [%b Packard2007 Veblen1899 Wu2016 %].
...
Becker's 1957 work on discrimination in labor markets generated an optimistic prediction [%b Becker1971 %].
...
Economists distinguish [%g taste-discrimination "taste-based discrimination" %],
in which employers simply prefer not to hire members of certain groups regardless of productivity,
from [%g statistical-discrimination "statistical discrimination" %],
...
The psychological research on [%g implicit-bias "implicit bias" %]
complicates the picture further [%b Banaji2013 %].
...
[%g audit-studies "Audit studies" %] provide the cleanest evidence.
...
even if they object adamantly to being accused of discrimination [%b McGhee2021 %].
...
The [%g flexner-report "Flexner Report" %] of 1910 recommended consolidating medical education
...
draws the pattern to its full historical length [%b Beard2017 %].
...
the primary mechanism of exclusion operates under the label of [%g culture-fit "culture fit" %].
