...
and eliminates the degrees of freedom that less tightly managed arrangement permitted [@Thompson1963].

::: {.callout-note title="Collective Resistance"}
...
Conveniently,
this gave the appearance of converting a power arrangement into a benevolent one [@Lindsey1942].
...
This is the Pullman model operating at a scale Pullman could not have imagined,
...
This competition is profitable because the goalposts move as soon as people approach them [@Veblen1899].
...
::: {.callout-note title="Manufactured Insecurity"}
