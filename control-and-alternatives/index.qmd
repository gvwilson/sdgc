...
frequently met with private and state violence [@Gordon2001].
...
::: {.callout-note title="Australia First"}
...
and that fulfillment is a legitimate criterion for choosing and evaluating a job [@Cech2021].
...
it is hard to know what is [@Waring1988].
...
which most households in wealthy countries had done by the 1980s [@Hochschild1989].
...
were primarily a way to discipline female labor [@Federici2004].
...
and women still perform more unpaid domestic labor [@Folbre2001].
...
which says a lot about whose history gets told [@Thompson1963;@Roediger1989].
...
that preceded and followed it [@Orleck1995].

::: {.callout-note title="New Zealand is Different"}
...
exercised by those with enough standing to enforce it [@Douglas2002].
...
As described [earlier](../how-we-got-here/index.qmd),
...
and has evolved into a way for senior management to avoid accountability [@Davies2025].
...
::: {.callout-note title="Nothing to Sell"}
...
[@Baiocchi2005;@Blasi2013;@Phillips2019;@Yunus2007].
