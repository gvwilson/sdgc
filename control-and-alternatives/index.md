...
The tech industry is a laggard when it comes to organizing,
but that just means there's a lot of prior art we can learn from.

## Labor and Passion

The achievements of organized labor
are consistently underestimated by people who have grown up with them:
...
frequently met with private and state violence [%b Gordon2001 %].
...
The German [%g mitbestimmung "Mitbestimmung" %] system
(the word means [%g codetermination "codetermination" %])
...
and that fulfillment is a legitimate criterion for choosing and evaluating a job [%b Cech2021 %].
...
Organizing feels like betrayal:
not because the employer has convinced workers that unions are bad,
but because they've been convinced that they aren't really workers at all
[%b Graeber2018 %].

<div class="callout" markdown="1">

The Japanese postwar *salaryman* (the white-collar male employee of a major corporation)
is the fullest institutional form of this identity fusion.
...
[%g karoshi "*Karoshi*" %] (death from overwork) was officially recognized as
...
it is hard to know what is [%b Waring1988 %].

In Japan,
the term *sengyo shufu*,
meaning "full-time housewife",
became widespread only in the postwar period,
...
which most households in wealthy countries had done by the 1980s [%b Hochschild1989 %].
...
This is the same mechanism as the passion principle:
...
were primarily a way to discipline female labor [%b Federici2004 %].
...
and women still perform more unpaid domestic labor [%b Folbre2001 %].
...
which says a lot about whose history gets told [%b Thompson1963 Roediger1989 %].
...
In 1889,
the newly-formed Second International
declared May 1 an international day of solidarity for the eight-hour day.
...
The conditions the fire exposed —were standard practice at the time:
locked exits, no sprinklers, overcrowding, and abusive supervisors.
...
that preceded and followed it [%b Orleck1995 %].
...
The books I own on software engineering cover project management,
software architecture,
team dynamics,
technical leadership,
and career development.
They do *not* cover workers' rights,
...
When you start a company here in Canada,
one of your first decisions is what kind of firm to create.
...
Most small businesses start this way because of the minimal paperwork required.
...
The [%g limited-liability-corporation "limited liability corporation" %]
is the dominant modern form of company.
As described in [an earlier essay](@/how-we-got-here/),
the notion of "limited liability" was created by governments
to encourage private investment in ventures too expensive or risky for one person to fund alone,
and has evolved into a way for senior management to avoid accountability [%b Davies2025 %].
